...
\begin{document}
	...
	\begin{figure}[ht]
		\centering
		\subfigure[$ c=-0.4+0.6i $]{\includegraphics[width=0.4\linewidth]{picture1}}
		\subfigure[$ c=-0.8+0.156i $]{\includegraphics[width=0.4\linewidth]{picture2}}
	\end{figure}
	\begin{figure}[ht]
		\centering
		\subfigure[$ c=0.28+0.01i $]{\includegraphics[width=0.4\linewidth]{picture3}}
		\subfigure[$ c=0.3+0.5i $]{\includegraphics[width=0.4\linewidth]{picture4}}
	\end{figure}
	\newpage
	\section{结论}
